...
public:
	...
	static __forceinline void LoadKey(const FAESKey& Key, KeySchedule& Schedule) {
...
#undef KEYEXP128_H
	...
	static __forceinline void DecodeInPlace(const FAESKey& Key, char* Buffer, size_t BufferSize) {
		KeySchedule Schedule;
		LoadKey(Key, Schedule);
