...
class EPixelFormatHelper {
public:
	static constexpr EPixelFormat GetType(const char* format) {
		switch (HStringHash::Crc32(format, strlen(format)))
		{
#define CASE(t) case HStringHash::Crc32(#t): return EPixelFormat::##t
